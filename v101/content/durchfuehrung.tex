...
\subsection{Bestimmung der Trägheitsmomente einfacher Körper}
...
\begin{figure}
    \centering
    \caption{Abbildung zur Bestimmung der Trägheitsmomente komplexer Körper:In dieser Abbildung ist eine Stellung der verwendete Holzpuppe auf der Drill-Achse zu sehen.}
    \label{fig:D_subfig}
