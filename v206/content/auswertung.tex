...
% Hier muss jetzt ne Tabelle mit den Werten für dm/dt aus plot.py hin    & die dazugehörige Fehlerrechnung (Fehler von dm/dt wenn dT/dt und L fehlerbehaftet sind)
% Einheiten technisch sollte es jetzt auch in der Plot.py passen, aber ka die Ergebnisse für die mechanische Leistung sind halt iwie sehr dubios