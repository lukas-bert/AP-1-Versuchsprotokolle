...
$T = \qty{373}{\kelvin}$ folgt $L_\text{a} = \qty{3101}{\joule\per\mol}$. Mit der Relation \autoref{eqn:LI} ergibt sich für die innere Verdampfungswärme
\begin{equation*}
...
Für einen Druckbereich $p_0 \geq \qty{1}{\bar}$ kann $L$ nicht mehr als konstant angenommen werden. Mit der Clausius-Clapeyronschen Gleichung \autoref{eqn:DGL1}
