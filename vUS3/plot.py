...
plt.plot(v_fluss30,v_diff30/np.cos(alpha[0]), marker = "x" ,color = "firebrick", linewidth = 0) 
...
plt.grid()
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
plt.plot(v_fluss15,v_diff15/np.cos(alpha[1]), marker = "x" ,color = "firebrick", linewidth = 0)
...
plt.grid()
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
plt.plot(v_fluss45,v_diff45/np.cos(alpha[2]), marker = "x" ,color = "firebrick", linewidth = 0) 
