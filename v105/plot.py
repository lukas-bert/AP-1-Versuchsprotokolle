...
r_m = unp.uarray(r_m,0.00001)
r_z = ufloat(0.995/2, 0.00001)
r_ks = ufloat(1.25, 0.00001)
r_ges = (r_m +  r_z + r_ks) #in cm
N = 195
R_Spule = 0.109
d = 0.138
...
plt.subplot(1, 2, 1)
plt.errorbar(unp.nominal_values(r_ges), unp.nominal_values(B),xerr = unp.std_devs(r_ges),yerr = unp.std_devs(B), fmt='ro',label='Messdaten')
